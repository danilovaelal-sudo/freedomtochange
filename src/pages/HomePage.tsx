    ...
    <SiteLayout>
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-end overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 pb-20 pt-40">
          ...
          <h1 className="text-[2.5rem] md:text-8xl lg:text-9xl font-black tracking-tighter leading-[0.85] uppercase mb-6 animate-fade-up animation-delay-200 max-w-5xl">
            ТЫ НЕ<br />
