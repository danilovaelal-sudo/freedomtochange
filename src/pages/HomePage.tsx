      ...
      <section className="py-24 md:py-32 px-6 border-t-[3px] border-foreground/10">
        <div className="max-w-[1400px] mx-auto">
          <ScrollReveal>
            ...
            <h2 className="heading-display mb-12 max-w-4xl">ПРОСТРАНСТВО,<br />ГДЕ <span className="text-primary">МОЖНО</span><br />НЕ СПЕШИТЬ</h2>
          </ScrollReveal>
            ...
            <ScrollReveal delay={300}>
              <div className="border-[3px] border-foreground/20 -ml-0 lg:-ml-[3px] -mt-[3px] lg:mt-0 p-8 md:p-12 bg-primary/5">
                ...
                <p className="body-editorial text-muted-foreground">
                  Проект вырос из личного опыта автора — Елены Даниловой, женщины, которая начинала заново не один раз.
                </p>
              </div>
            </ScrollReveal>
          </div>
          <ScrollReveal delay={300}>
            <div className="border-[3px] border-foreground/10 p-8 md:p-12 mt-16">
              <h3 className="heading-section mb-8">ЧТО ЗДЕСЬ<br />МОЖНО ДЕЛАТЬ</h3>
              <div className="space-y-4">
                {['Читать — книгу, дневник, размышления', 'Проходить тесты — без регистрации, без сохранения', 'Исследовать себя — через интерактивные маршруты', 'Получать поддержку — через историю автора', 'Найти следующий шаг — если будешь готова'].map((item, i) => (
          ...
          <ScrollReveal delay={400}>
            <div className="mt-16 p-8 md:p-12 bg-primary/5 border-[3px] border-primary/20">
              <h3 className="heading-section mb-8">ПОЧЕМУ ЭТА<br />ТЕМА ВАЖНА</h3>
          ...
          <ScrollReveal delay={500}>
            <div className="mt-16 flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/book" className="brutal-btn-outline text-center">Открыть книгу</Link>
            </div>
          </ScrollReveal>
        </div>
      </section>
