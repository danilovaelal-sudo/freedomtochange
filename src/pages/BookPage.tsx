...
export default function BookPage() {
  return (
    <SiteLayout>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-5 gap-0 items-stretch">
          <ScrollReveal className="lg:col-span-2">
            <div className="border-[3px] border-foreground/20 p-4 bg-card h-full flex items-center justify-center group overflow-hidden">
              <img src={bookCover} alt="Почему после 40 не поздно. И есть ли жизнь после монастыря?" className="w-full max-w-md group-hover:scale-105 transition-all duration-700" width={640} height={960} />
            </div>
          </ScrollReveal>
          <ScrollReveal delay={200} className="lg:col-span-3">
            <div className="border-[3px] border-foreground/20 -ml-0 lg:-ml-[3px] -mt-[3px] lg:mt-0 p-8 md:p-12 h-full flex flex-col justify-center">
              ...
              <h1 className="heading-display mb-4">ПОЧЕМУ ПОСЛЕ 40<br /><span className="text-primary">НЕ ПОЗДНО</span></h1>
              <p className="text-xl text-muted-foreground mb-2">И есть ли жизнь после монастыря?</p>
              <p className="text-mono text-primary/60 mb-8">Елена Данилова</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="https://www.litres.ru/book/elena-danilova-32959/pochemu-posle-40-ka-ne-pozdno-i-est-li-zhizn-posle-mo-70398937/" target="_blank" rel="noopener noreferrer" className="brutal-btn-outline text-center">
        ...
        <div className="max-w-3xl mx-auto border-[3px] border-foreground/10 p-8 md:p-12">
          <ScrollReveal>
            ...
            <div className="body-editorial text-muted-foreground space-y-6">
              ...
              <p>И, в конце концов, — это просто любопытная и весьма необычная история.</p>
            </div>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          <ScrollReveal>
            ...
            <div className="body-editorial text-muted-foreground space-y-6 border-[3px] border-foreground/10 p-8 md:p-12">
              ...
              <p>Монастырь был запрещенной темой для меня 10 лет точно после того, как я вернулась к прежней жизни. Я не могла говорить об этом даже с мужем. Очень злилась на него, когда он с гордостью говорил в компаниях, что его жена из монастыря.</p>
              ...
              <p>Итак, приглашаю вас, друзья, вместе со мной вспомнить и еще раз прожить.</p>
            </div>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          <ScrollReveal>
            ...
            <div className="space-y-0">
              {[
                'Женщинам, которые чувствуют, что прежняя жизнь больше не подходит',
                'Тем, кто переживает внутренний кризис или период перемен',
      ...
      {/* Buy */}
      <section className="py-20 px-6 border-t-[3px] border-primary/30 bg-primary/5">
        <ScrollReveal>
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="heading-section mb-8">ЧИТАТЬ<br />КНИГУ</h2>
            <p className="text-muted-foreground text-lg mb-8">Электронная версия доступна на Литрес</p>
            <a href="https://www.litres.ru/book/elena-danilova-32959/pochemu-posle-40-ka-ne-pozdno-i-est-li-zhizn-posle-mo-70398937/" target="_blank" rel="noopener noreferrer" className="brutal-btn inline-block animate-pulse-border">
              Купить на Литрес →
            </a>
          </div>
        </ScrollReveal>
      ...
      <section className="py-20 px-6 border-t-[3px] border-foreground/10">
        <ScrollReveal>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/interactives" className="brutal-btn-outline text-center">Погрузиться в пространство</Link>
